    ...
    <div className="p-8 md:p-16 max-w-5xl mx-auto">
      ...
      >
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <span className="data-label text-blue-500">SUBSCRIPTION_ACTIVE</span>
            <h1 className="font-sans text-3xl md:text-4xl font-medium leading-none uppercase">Welcome to Statsez</h1>
          </div>
        </div>
        ...
        <div className="mt-24 border-t border-border pt-12 flex flex-col md:flex-row justify-between gap-8">
          <div className="max-w-md">
            <h3 className="font-sans text-xl font-medium uppercase mb-4 tracking-tight">Suporte</h3>
            <p className="text-base text-muted-foreground leading-relaxed">
              Precisa de ajuda? Entre em contato via Telegram @joaonaithen.
            </p>
          </div>
          <a
            href="/dashboard"
            className="self-start md:self-end font-mono text-sm font-bold uppercase tracking-[0.15em] bg-foreground text-background px-10 py-5 hover:bg-foreground/90 transition-all duration-300 flex items-center gap-3"
          >
